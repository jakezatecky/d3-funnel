...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_local__ = __webpack_require__(71);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_mouse__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_select__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_selectAll__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_selectorAll__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_touch__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_touches__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_window__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_selection_on__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filter__ = __webpack_require__(85);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__exit__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__merge__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__order__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sort__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__call__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__nodes__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__node__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__size__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__empty__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__each__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__attr__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__style__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__property__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__classed__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__text__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__html__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__raise__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__lower__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__append__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__insert__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__remove__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__datum__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__on__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__dispatch__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_lab__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_cubehelix__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_timeout__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_interval__ = __webpack_require__(104);
...
var _shortid = __webpack_require__(128);

var _shortid2 = _interopRequireDefault(_shortid);

var _d = __webpack_require__(127);

var _d3Selection = __webpack_require__(0);

__webpack_require__(69);

var _Colorizer = __webpack_require__(39);

var _Colorizer2 = _interopRequireDefault(_Colorizer);

var _LabelFormatter = __webpack_require__(41);
  ...
  */
		...
		value: function standardizeData(data, totalCount) {
			...
			data.forEach(function (block, index) {
				...
				standardized.push({
					...
					ratio: ratio,
					value: count,
					height: _this2.settings.height * ratio,
					fill: _this2.colorizer.getBlockFill(block, index, _this2.settings.fillType),
					label: {
						raw: label,
   ...
   */
		...
		value: function drawOntoDom() {
			// Add the SVG
			this.svg = (0, _d3Selection.select)(this.selector).append('svg').attr('id', this.id).attr('width', this.settings.width).attr('height', this.settings.height);
		...
		value: function makePaths() {
			...
			if (this.settings.bottomPinch > 0) {
				this.blocks.forEach(function (block, i) {
					...
					if (_this3.settings.minHeight !== 0) {
						height += _this3.settings.minHeight;
					}

					// Account for any curvature
					if (_this3.settings.isCurved) {
						height += _this3.settings.curveHeight / _this3.blocks.length;
					}

					if (_this3.settings.isInverted) {
						if (i < _this3.settings.bottomPinch) {
							slopeHeight -= height;
						}
					} else if (i >= _this3.blocks.length - _this3.settings.bottomPinch) {
						slopeHeight -= height;
					}
				});
			}
			...
			this.blocks.forEach(function (block, i) {
				...
				if (_this3.settings.dynamicHeight) {
					// Slice off the height proportional to this block
					dy = totalHeight * block.ratio;

					// Add greedy minimum height
					if (_this3.settings.minHeight !== 0) {
						dy += _this3.settings.minHeight;
					}

					// Account for any curvature
					if (_this3.settings.isCurved) {
						dy -= _this3.settings.curveHeight / _this3.blocks.length;
					}
					...
					if (_this3.settings.isInverted) {
						nextLeftX = (prevHeight + dy - _this3.settings.height) / (-1 * slope);
					}

					// If bottomWidth is 0, adjust last x position (to circumvent
					// errors associated with rounding)
					if (_this3.settings.bottomWidth === 0 && i === _this3.blocks.length - 1) {
						// For funnel, last position is the center
						nextLeftX = _this3.settings.width / 2;
					...
					if (_this3.settings.bottomWidth === _this3.settings.width) {
						nextLeftX = prevLeftX;
					}
				...
				if (_this3.settings.dynamicSlope && !_this3.settings.isInverted) {
				...
				if (_this3.settings.bottomPinch > 0) {
					// Check if we've reached the bottom of the pinch
					// If so, stop changing on x
					if (!_this3.settings.isInverted) {
						if (i >= _this3.blocks.length - _this3.settings.bottomPinch) {
							dx = 0;
						}
						...
						dx = i < _this3.settings.bottomPinch ? 0 : dx;
					}
				}
				...
				var dimensions = {
					...
					curveHeight: _this3.settings.curveHeight,
					ratio: block.ratio
				};
				...
				if (_this3.settings.isCurved) {
					...
					if (_this3.settings.addValueOverlay) {
   ...
   */
		...
		value: function drawBlock(index) {
			...
			if (this.settings.addValueOverlay) {
				...
				if (this.settings.animation !== 0) {
					overlayPath.transition().duration(this.settings.animation).ease(_d.easeLinear).attr('fill', this.blocks[index].fill.actual).attr('d', this.getOverlayPathDefinition(index));
				} else {
			...
			if (this.settings.onBlockClick !== null) {
				[path, overlayPath].forEach(function (target) {
					...
					target.style('cursor', 'pointer').on('click', _this5.settings.onBlockClick);
				});
			}
...
(function (global, factory) {
   true ? factory(__webpack_require__(0), __webpack_require__(106)) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_interrupt__ = __webpack_require__(36);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__interrupt__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__interpolate__ = __webpack_require__(37);
...
var randomByte = __webpack_require__(133);
...
var decode = __webpack_require__(129);
var isValid = __webpack_require__(132);
...
var clusterWorkerId = __webpack_require__(135) || 0;
...
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } /* global _ */
...
var chart = new _index2.default('#funnel');
